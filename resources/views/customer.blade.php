    ...
    <table class="table table-bordered data-table">
      <thead>
        <tr>
          ...
          <th class="border-gray-200">Shopkeeper</th>
          <th class="border-gray-200">Product Name</th>
          <th class="border-gray-200">MRP</th>
          <th class="border-gray-200">Sell Price</th>
          <th class="border-gray-200">Expiry</th>
          <th class="border-gray-200">Country</th>
          <th class="border-gray-200">State</th>
 ...
 $(document).ready(function () {
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            { data: 'shopkeepers', name: 'shopkeepers.name', render: function(data) {
            return data.map(function(shopkeeper) {
            return shopkeeper.name; }).join(', ');
            }},  
            ...
            { data: 'address', name: 'address' },
              {   data: 'action',
                ...
                render: function (data, type, full, meta) {
                    ...
                    var deleteUrl = "{{ route('customer.destroy', ':id') }}";
                    ...
                    var ProductUrl = "{{route('product.data', ':id')}}";
                    ProductUrl = ProductUrl.replace(':id', full.id);
                    var productButton = '<a href="' + ProductUrl + '" class="product m-3" title="product" data-toggle="tooltip" data-placement="top">' +
                        '<i class="bi bi-images"></i>' +
                        '</a>';
                    
                    return productButton +' '+ editButton + ' ' + deleteButton;
                }
            }
        ]
    });
